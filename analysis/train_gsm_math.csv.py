...
df_train = df_train[["task_name","question", "ground_truth"]].reset_index(drop=True)

df_train.to_csv("/mnt/d/OneDrive/兰州交大/博士课题-大模型/LLMProject/AFCuRL_MathReasoning/data/benchmarks/train_gsm_math.csv", index=False)
